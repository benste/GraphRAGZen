...
def generate_domain(llm: LLM, documents: List[str], config: GenerateDomainConfig) -> str:
...
def generate_persona(
    llm: LLM, domain: str, config: GeneratePersonaConfig
) -> str:
...
def generate_entity_types(
    ...
    domain: str,
    persona: str,
    config: GenerateEntityTypesConfig,
) -> str | list[str]:
...
def generate_entity_relationship_examples(
    ...
    config: GenerateEntityRelationshipExamplesConfig,
) -> list[str]:
    ...
    Args:
        ...
        config (EntityRelationshipExamplesConfig): _description_
...
def create_entity_extraction_prompt(
    ...
    config: CreateEntityExtractionPromptConfig,
) -> str:
    """
    ...
    Args:
        ...
        config (EntityExtractionPromptConfig)
...
def create_entity_summarization_prompt(persona: str, config: CreateEntitySummarizationPromptConfig) -> str:
